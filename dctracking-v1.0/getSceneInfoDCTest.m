function sceneInfo=getSceneInfoDCDemo
...
sceneInfo.detfile=fullfile(dbfolder,'det','00059.xml');
sceneInfo.frameNums=0:1002;
sceneInfo.imgFolder=fullfile(dbfolder,'img',filesep);
sceneInfo.imgFileFormat='frame_%03d.jpg';
...
% sceneInfo.targetSize=300;                % target 'radius'
